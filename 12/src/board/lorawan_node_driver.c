 ...
 * @endcode
 */
extern uint32_t tpro_time;
extern uint32_t pro_time;
extern uint8_t time_str[];
static bool node_block_join(uint16_t time_second)
{
...
#endif
		LCD_ShowString(48,40,"initializing",BLUE);
...
#endif
						LCD_ShowString(48,56,"join failed",BLUE);
            return false;
        }
    ...
    DEBUG_PRINTF("Join seccussfully\r\n");
		...
		LCD_ShowString(48,40,"joined,press k1",BLUE);
		//LCD_ShowString(48,52,"press k1",BLUE);
    // 5.若未超时返回则表明模块入网成功
